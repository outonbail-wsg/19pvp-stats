...
ALL_LOBBIES_ONLY = {
    ...
    "16_humans_vs_bots",        # entirely about the human/bot split
    "21_realgames_overview",    # already the contested slice
    "22_realgames_team_compare",
    "23_realgames_length",      # compares full lobbies against the rest
    "24_contested_record",      # needs both sides of the comparison
}
